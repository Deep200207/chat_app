...
import {
  MessageCircle, UserCircle2, SendHorizonal, LogOut
  ...
  return (
    <div>
      ...
      <main className='md:flex'>
        ...
        {<div className=' bg-slate-100 h-130 overflow-scroll hidden md:flex w-[40%] '>
        ...
        {selected ? <div className='w-[60%] hidden md:flex'>
          <div className='w-full'>
